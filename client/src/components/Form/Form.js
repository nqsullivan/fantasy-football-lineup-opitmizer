    ...
    return (
        <Paper className={classes.paper}>
            <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
                ...
                <TextField name={"position"} variant={"outlined"} label={"Position"} fullWidth value={playerData.position} onChange={(e) => {e.preventDefault(); setPlayerData({ ...playerData, position: e.target.value})}}/>
